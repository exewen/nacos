...
namespace Exewen\Nacos\Util;

class FileUtil
{
    private static string $snapshotPath = "nacos/config";
     ...
     * @return void
     */
    public function saveSnapshot(string $namespaceId, string $dataId, string $group, $dataIdConfig)
    {
